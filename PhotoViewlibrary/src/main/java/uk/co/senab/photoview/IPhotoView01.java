...
public interface IPhotoView01 {
     ...
     * @param listener - Listener to be registered.
     */
    void setOnMatrixChangeListener(PhotoViewAttacher01.OnMatrixChangedListener listener);
     ...
     * @param listener - Listener to be registered.
     */
    void setOnPhotoTapListener(PhotoViewAttacher01.OnPhotoTapListener listener);
     ...
     */
    PhotoViewAttacher01.OnPhotoTapListener getOnPhotoTapListener();
     ...
     * @param listener - Listener to be registered.
     */
    void setOnViewTapListener(PhotoViewAttacher01.OnViewTapListener listener);
     ...
     */
    PhotoViewAttacher01.OnViewTapListener getOnViewTapListener();
     ...
     */
    IPhotoView01 getIPhotoViewImplementation();
     ...
     */
    void setOnScaleChangeListener(PhotoViewAttacher01.OnScaleChangeListener onScaleChangeListener);
}
