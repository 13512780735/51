package com.likeit.a51scholarship.chat.message.message_chat_list;
...
public class ConversationFragment extends EaseConversationListFragment {
    ...
    protected void initView() {
        super.initView();
        View errorView = (LinearLayout) View.inflate(getActivity(),R.layout.fragment_conversation, null);
