...
public class UserInfoBean implements Serializable {
    ...
    public String getWant_country() {
        return want_country;
    }

    public void setWant_country(String want_country) {
        this.want_country = want_country;
    }

    public String getWant_education() {
        return want_education;
    }

    public void setWant_education(String want_education) {
        this.want_education = want_education;
    }
