...
public class NoScrollViewPager02 extends ViewPager {
    private boolean noScroll = false; // true 代表不能滑动 //false 代表能滑动

    public NoScrollViewPager02(Context context, AttributeSet attrs) {
        super(context, attrs);
    ...
    public NoScrollViewPager02(Context context) {
        super(context);
    }
